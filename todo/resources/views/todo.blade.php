...
@section('content')
  ...
  <div class="mt-3">
    <form action="{{ route('todos.store') }}" method="POST" class="row g-3 justify-content-center">
      @csrf
        <div class="col-lg-6">
            <input type="text" class="form-control" name="title" id="title" placeholder="What are you planning todo?"></input>
        </div>
        <div class="col-auto">
  ...
  <div class="mt-3">
      ...
      @foreach ($todos as $todo)
        <li class="list-group-item d-flex justify-content-between align-items-center">
            <span @class(['text-decoration-line-through' => $todo->completed])>{{ $todo->title }}
